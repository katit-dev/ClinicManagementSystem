...
-- 19 bang goc -> 28 bang theo pham vi da chot.
-- Nguon: DBML goc + muc 3, 4, 7, 9 trong ban review cua thay.
-- Khong them permissions, role_permissions, notifications, clinic_settings.
...
');
        ...
        COMMIT TRANSACTION;
        PRINT N'Da nang cap schema tu 19 len 28 bang.';
    END TRY
    BEGIN CATCH
...
-- Kiem tra danh sach 28 bang (khong tinh system tables).
